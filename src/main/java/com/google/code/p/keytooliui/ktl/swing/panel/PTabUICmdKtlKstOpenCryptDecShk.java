...
public final class PTabUICmdKtlKstOpenCryptDecShk extends PTabUICmdKtlKstOpenCryptDecAbs
{
    // ---------------------------
    // private static final String
    
    public static final String STR_TITLETASK = "Decrypt data file with secret key entry & save as file";
