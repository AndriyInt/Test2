...
public final class KTLKprOpenDecRsaPkcs12 extends KTLKprOpenDecRsaAbs
{
    // ------
    // PUBLIC

    public KTLKprOpenDecRsaPkcs12(
        Frame frmOwner, 
        ...
        )
    {
        ...
        if (! super._doJob_(kstOpen, strAliasKpr, new char[0], fleOpenData, fleSaveData))
        {
