...
public abstract class DTblsKstSelPKAbs extends DTblsKstSel 
{
    // ---------------
    // public abstract
    ...
    public void valueChanged(ListSelectionEvent evtListSelection)
    {
        ...
        if (intSelectionRow<0 || intSelectionRow>super._boosIsCandidatePKTC_.length-1)
            MySystem.s_printOutExit(this, strMethod, "intSelectionRow<0 || intSelectionRow>this._boosIsCandidatePKTC_.length-1");
            
        if (this._boosIsCandidatePKTC_[intSelectionRow].booleanValue() == false)
            this._tfdAlias.setText("");
        else
