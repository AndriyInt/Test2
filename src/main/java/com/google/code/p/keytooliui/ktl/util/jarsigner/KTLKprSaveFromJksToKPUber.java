...
/**
    ...
    KTLKprSaveFromJksToKPUber: "Kpr" for "KeyPair", 
    create a new entry in existing UBER keystore by importing a KeyPair entry from JKS keystore
...
public final class KTLKprSaveFromJksToKPUber extends KTLKprSaveFromJksToKPAbs
{
    ...
    **/
    ...
    public KTLKprSaveFromJksToKPUber(
        Frame frmOwner, 
