...
/**
    ...
    KTLKprSaveFromUberToJceks: "Kpr" for "KeyPair", 
    create a new entry in existing JCEKS keystore by importing a KeyPair entry from UBER keystore
...
public final class KTLKprSaveFromUberToKPJceks extends KTLKprSaveFromUberToKPAbs
{
    // ------
    // PUBLIC
    ...
    **/
    ...
    public KTLKprSaveFromUberToKPJceks(
        Frame frmOwner, 
        ...
        )
    {
        super(
            ...
            KTLAbs.f_s_strProviderKstJceks // provider for keystore-target of type JCEKS
            );
    }
