...
/**
    ...
    KTLKprSaveFromBksToJceks: "Kpr" for "KeyPair", 
    create a new entry in existing JCEKS keystore by importing a KeyPair entry from BKS keystore
...
public final class KTLKprSaveFromBksToKPJceks extends KTLKprSaveFromBksToKPAbs
{
    ...
    **/
    ...
    public KTLKprSaveFromBksToKPJceks(
        Frame frmOwner, 
