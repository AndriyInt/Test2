...
public abstract class KTLShkOpenCryptEncAbs extends KTLShkOpenCryptAbs
{
    // ------------------
    // protected abstract
    ...
    **/
    public boolean doJob()
    {
        ...
        File fleSaveCrypt = UtilJsrFile.s_getFileSave(
            super._frmOwner_, super._strPathAbsFileDataSave_,
            true // blnShowDlgOverwrite
            );
        
        if (fleSaveCrypt == null)
        {
            super._setEnabledCursorWait_(false);
            MySystem.s_printOutWarning(this, strMethod, "nil fleSaveCrypt");
            return false;
        }
    ...
    **/
        ...
        )
    {
        ...
        String strMethod = "_doJob_(kstOpen, strAliasShk, chrsPasswdShk, fleSaveCrypt, fleOpenData)";
        
        if (kstOpen==null || strAliasShk==null || chrsPasswdShk==null || fleSaveCrypt==null || fleOpenData==null)
        ...
        try
        {
            ...
            OutputStream osm =new FileOutputStream(fleSaveCrypt);
            String strInstanceCipher = key.getAlgorithm();
            
            KTLShkAbs._s_encrypt_(sky, ism, osm, strInstanceCipher);
        }
        ...
        catch(Exception exc)
        {
            ...
            String strBody = "Failed to encrypt file."; 
            strBody += "\n" + exc.getMessage();
        ...
        String strBody = "Data file successfully encrypted with secret key aliased:";
        strBody += "\n  " + strAliasShk;
        strBody += "\n\nEncrypted file saved as:";
        strBody += "\n  " + fleSaveCrypt.getAbsolutePath();
    ...
    protected KTLShkOpenCryptEncAbs(
        Frame frmOwner, 
        ...
        String strPathAbsFileSaveCrypt, // cryptnature to save
