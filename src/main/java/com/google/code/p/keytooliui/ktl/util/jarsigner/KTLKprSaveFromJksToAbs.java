...
/**
    known subclasses:
    . KTLKprSaveFromJksToPkcs12
    . KTLKprSaveFromJksToKPAbs
...
public abstract class KTLKprSaveFromJksToAbs extends KTLKprSaveFromAbs
{
    // ---------
    // PROTECTED
    ...
    **/
        ...
        )
    {
        ...
        Boolean[] boosElligibleSource = super._getBoosElligibleAny_(boosEntryKprSource, strsAlgoKeyPublSource, boosTypeCertX509Source);
    ...
    protected KTLKprSaveFromJksToAbs(
        Frame frmOwner, 
        ...
        )
    {
        super(
            ...
            strPathAbsKstSource,
            chrsPasswdKstSource,
            KTLAbs.f_s_strProviderKstJks, // provider for keystore-source
    ...
    **/
        ...
        )
    {
        ...
        String[] strsSizeKeyPublSource = UtilKstAbs.s_getStrsSizeKeyPubl(super._frmOwner_, kstOpenTarget, strsAliasTarget);
        ...
        String[] strsAlgoKeyPublSource = UtilKstAbs.s_getStrsAlgoKeyPubl(super._frmOwner_, kstOpenTarget, strsAliasTarget);
        ...
        else // no password for entry, eg PKCS12
        {
        }
