...
public class DTblsKstSelPKOpenNoPassRsa extends DTblsKstSelPKOpenNoPass
{
        ...
        )
    {
        ...
        {
            MySystem.s_printOutExit(strMethod, "nil boosIsPKRsaEntryPKTC");
        }
        
        if (! _keystoreContainsValidCandidate(boosIsPKRsaEntryPKTC))
        {
    ...
    public DTblsKstSelPKOpenNoPassRsa(
