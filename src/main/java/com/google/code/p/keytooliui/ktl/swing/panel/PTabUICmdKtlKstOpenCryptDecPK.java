...
public final class PTabUICmdKtlKstOpenCryptDecPK extends PTabUICmdKtlKstOpenCryptDecAbs
{
    // ---------------------------
    // private static final String
    
    public static final String STR_TITLETASK = "Decrypt data file with RSA private key entry";
