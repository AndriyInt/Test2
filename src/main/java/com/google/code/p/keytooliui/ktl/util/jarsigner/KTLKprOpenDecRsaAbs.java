...
public abstract class KTLKprOpenDecRsaAbs extends KTLKprOpenDecAbs
{
    // ------------------
    // protected abstract
    ...
    if any error in code, exiting
        ...
        . get fileSave Dec (MEMO: check for files prior to open up trusted certificate entries selection dialog)
        . open keystore
    ...
    **/
    ...
    {
        String strMethod = "_doJob_(kstOpen, strAliasKpr, chrsPasswdKpr, fleOpenData, fleSaveData)";
        
        if (kstOpen==null || strAliasKpr==null || chrsPasswdKpr==null || fleOpenData==null || fleSaveData==null)
        ...
        try
        {
            pky = (PrivateKey) kstOpen.getKey(strAliasKpr, chrsPasswdKpr);
        }
        ...
        Certificate crtEntryKpr = null;
        
        try
        {
            crtEntryKpr = kstOpen.getCertificate(strAliasKpr);
        }
        ...
        try
        {
            crtX509 = (X509Certificate) crtEntryKpr;
        }
        ...
        try
        {
            ...
            KTLAbs._s_decryptRsa_(pky, ism, osm, intSizeFileInput, this._strInstanceCipherAlgo);      
        }
