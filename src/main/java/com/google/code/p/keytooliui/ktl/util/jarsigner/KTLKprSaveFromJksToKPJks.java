...
/**
    ...
    KTLKprSaveFromJksToKPJks: "Kpr" for "KeyPair", 
    create a new entry in existing JKS keystore by importing a KeyPair entry from JKS keystore
...
public final class KTLKprSaveFromJksToKPJks extends KTLKprSaveFromJksToKPAbs
{
    ...
    **/
    ...
    public KTLKprSaveFromJksToKPJks(
        Frame frmOwner, 
        ...
        )
    {
        super(
            ...
            KTLAbs.f_s_strProviderKstJks // provider for keystore of type JKS
            );
    }
